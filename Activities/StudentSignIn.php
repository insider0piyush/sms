            ...
            <div class="centered">
                            ...
                            <td>
                                <tr>
                                    <table>
                                        ...
                                        <td>
                                            <div>
                                                <input type="email" name="studemail" id="studemail" style="margin-inline-start: 7px ; padding: 7px ; 
                                    ...
                                    <table>
                                        ...
                                        <td>
                                            <div>
                                                <input type="password" name="studpassword" id="studpassword" style="margin-inline-start: 7px ; padding: 7px ; margin-top: 5px;
                                                        width: 250px ; border-radius:12px ; 
                                                        outline-color: transparent ; border-color: transparent ; "
                ...
                <table>
                    <tr>
                        ...
                        <form action="#" method="post">
                            <div style="margin-bottom: 17px">
                                <button class="btn frgt" name="forgotPassword" id="forgotPassword" style="
                                    padding-left: 32px;
                                    padding-right: 32px;
                                    padding-top: 7px;
                                    padding-bottom: 7px;
